            ...
            self.defaults = {
                ...
                fileTypeSettings: {
                    ...
                    video: function (vType, vName) {
                        return $h.compare(vType, 'video.*') && ($h.compare(vType, /(ogg|mp4|mp?g|mov|webm|3gp|m4a)$/i) ||
                            $h.compare(vName, /\.(og?|mp4|webm|mp?g|mov|3gp|m4a)$/i));
                    },
                    audio: function (vType, vName) {
                        return $h.compare(vType, 'audio.*') && ($h.compare(vName, /(ogg|mp3|mp?g|wav|m4a)$/i) ||
                            $h.compare(vName, /\.(og?|mp3|mp?g|wav|m4a)$/i));
                    },
